...
// 		console.log("getPath:",getPath);
	...
	appendMeta : function ( urlObj , isAsyn )
	{
		...
		var resUrlObj = urlObj != null && urlObj != defUrlObj ? 
						(function () 
						{
							resUrlObj = Object.assign( defUrlObj.meta , urlObj.meta ) ;
	...
	appendScript : function ( urlObj , isAsyn )
	{
		...
		var resUrlObj = urlObj != null && urlObj != defUrlObj ? 
						(function () 
						{
							resUrlObj = Object.assign( defUrlObj.script , urlObj.script ) ;
							var nonp = resUrlObj.hasNullPointer() ;
							return nonp.unit ;
						})() : 
						defUrlObj.script ; 
	...
	appendIni : function ( urlObj , isAsyn ) 
	{
		...
		$append_mls.appendCssJs( urlObj , false ) ;
