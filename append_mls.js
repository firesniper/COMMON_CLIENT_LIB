	...
	Array.prototype ,
	{
		"setIndex" : {
			...
			value : function ( unitsGroup ) 
			{
				...
				for ( var i = 0 ; i < unitsGroup.length ; i++ )
				{
					if ( unitsGroup[ i ].constructor.name != "Object" ) 
							throw new TypeError( "index type must is Object" ) ;
					unitsGroup[ i ].index = i ;
				} ;
				return unitsGroup ;
			} ,
		} ,
	...
	Object.prototype ,
	{
		"setIndex" : {
			...
			value : function ( unitsGroup ) 
			{
				...
				{
					if ( unitsGroup.hasOwnProperty( key ) == false ) continue hfA01 ;
					try
					{  
