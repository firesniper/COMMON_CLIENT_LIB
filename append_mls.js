...
// 		console.log("getPath:",getPath);
	...
	appendMeta : function ( urlObj , isAsyn )
	{
		...
		var metaEleObj = scIns_InsObj.crtEleObj( resUrlObj , "meta" ) ;
...
// 							console.log( "resUrlObj:" , resUrlObj ) ;
						...
						defUrlObj.link ; 
		console.log( "resUrlObj : " , resUrlObj ) ;
		scIns_InsObj.distribute( resUrlObj , isAsyn , "link" ) ;
	} ,
	appendScript : function ( urlObj , isAsyn )
	{
		...
		var resUrlObj = urlObj != null && urlObj != defUrlObj && urlObj.script ? 
						( function () 
						{
							...
							return defUrlObj.script.concat( urlObj.script ) ;
						})() : 
						defUrlObj.script ; 
		console.log( "resUrlObj:" ,resUrlObj ) ;
		scIns_InsObj.distribute( resUrlObj , isAsyn , "script" ) ;
	} ,
